...
class Tab2(Tab):
    ...
    def column_2(self):
        ...
        password = self.stremlitbuilder.st_textinput(
    ...
    def column_3(self):
        ...
        #     )
        scroll = self.stremlitbuilder.st_slider(
            label="How many times you want to scroll?",
            min_value=0,
            max_value=50,
            step=5,
        )
...
def create():
    ...
    tab1builder = Tab2(
        stremlitbuilder
    )  # will call tab2 create_view and provide layout for tab 2
    ...
    try:
        if submit_button:
            ...
            twitterInstance = (
                ...
                if headless == "Yes"
                else bot_twiter.create(browser_name=browser_name, headless=False)
            )
