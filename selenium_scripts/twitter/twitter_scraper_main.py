...
def twitter_scraper_main(twitterInstance,driver,username, password, search_term,max_scroll):
    last_position = None
    ...
    while not end_of_scroll_region:
        ...
        si += 1 
        if si <= max_scroll:
            last_position, end_of_scroll_region = twitterInstance.scroll_down_page(last_position)
        else:
